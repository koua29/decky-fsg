...
const en = {
  ...
  libraryPending: "Pricing your library…",
  libraryHint: "Items include DLC: the store prices them together.",
  betaTag: "beta",
...
const fr: typeof en = {
  ...
  libraryPending: "Estimation de ta bibliothèque…",
  libraryHint: "Les éléments comptent les DLC : le store les chiffre ensemble.",
  betaTag: "bêta",
