...
- **Valeur récupérée** : total des prix normaux des jeux que FSG t'a ajoutés, avec le détail jeu par jeu, consultable sur une **vue dédiée** du panneau (bouton « Voir les statistiques », avec un retour), avec la valeur de ta bibliothèque Steam. Ce calcul ne part **que** sur appui du bouton « Recalculer les statistiques » : rien ne tourne en tâche de fond sur la console.
...
*Liens partenaires Amazon : si vous achetez via ces liens, le projet touche une petite commission, sans surcoût pour vous. Des accessoires pour les consoles portables SteamOS sur lesquelles FSG s'installe.*
