...
- **Valeur récupérée** : total des prix normaux des jeux que FSG t'a ajoutés, avec le détail jeu par jeu, plus une estimation de la valeur de ta bibliothèque Steam (rafraîchie une fois par semaine).
